...
export default function WorksInfo(props: Props) {
  ...
  const getUrlFontSize = (url: string) => {
    ...
    if (length > 80) return "clamp(0.7rem, 1.0vw, 1.6rem)";
    if (length > 60) return "clamp(0.9rem, 0.9vw, 1.8rem)";
    if (length > 40) return "clamp(1.1rem, 1.1vw, 2.0rem)";
  ...
  const getUrlUnderlineTop = (url: string) => {
    ...
    if (length > 80) return "clamp(1.0rem, 0.96vw, 1.6rem)";
    if (length > 60) return "clamp(1.2rem, 1.0vw, 1.8rem)";
    if (length > 40) return "clamp(1.4rem, 1.1vw, 2.0rem)";
