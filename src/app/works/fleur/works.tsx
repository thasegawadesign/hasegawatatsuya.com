            ...
            <WorksInfo
              ...
              why={
                <>
                  ...
                  「グルテンフリー」「美しさ」「清潔感」をキーワードに企画しました.
                </>
              }
              how={
                <>
                  職人の技が光る, 美しく仕上げられたマカロンを引き立たせるため,
                  シンプルで清潔感のある白を基調としたデザインに仕上げました.
                  <br />
                  ブランド名の「フルール」は, フランス語で“花”を意味し,
                  小さくて愛らしいマカロンのイメージにぴったりだと感じて命名しました.
                  <br />
                  ビジュアルデザインでは,
                  由来にちなんで花のモチーフをさりげなく装飾に取り入れ,
                  マカロンの丸みを造形に活かし,
                  統一感とやわらかさを表現しました.
                  <br />
                  技術面では,
                  操作対象にミニマルなインタラクションを実装することで,
                  細部まで丁寧に作り込みました.
                </>
              }
              role={
