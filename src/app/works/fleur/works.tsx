        ...
        <Glass>
          ...
          <main className={clsx(main)}>
            <WorksInfo
              ...
              imageWidth={2640}
              imageHeight={1520}
              what="健康志向で美しいスイーツが好きな人のための架空マカロン専門店フルールのブランドサイト"
              why={
                <>
                  トレンドに敏感なターゲットに向けたWebサイト制作を経験してみたいと思い、制作しました。
                  <br />
                  口にするものには特別感を求める健康志向な人に届けるために、グルテンフリー・美・清潔感をキーワードにしています。
                </>
              }
              how={
                <>
                  職人の技が輝く仕上げの美しいマカロンを際立たせるために、シンプルで清潔感のある白基調のデザインに仕上げました。
                  <br />
                  フランス語で花という意味の「フルール」は、小さくてかわいいマカロンにぴったりだと思い、ブランドを命名しました。
                  <br />
                  ビジュアルデザインにおいては、モチーフをさりげなく使用できるのではないかと考え、ブランド名の由来である花の装飾を施しました。また、マカロンの丸みをセクションの造形に活用しました。
                  <br />
                  技術面では、操作可能な要素には控えめなインタラクションを実装して細部を作り込みました。
                </>
              }
              role={
                <>
