        ...
        <Glass>
          ...
          <main className={clsx(main)}>
            <WorksInfo
              ...
              how={
                <>
                  爽やかな草原に、象徴的なオレンジのソファを置いた奇妙な世界観を目指しました。文字のない空間ではありますが、ある意味記号的な要素からは逃れられない人間世界を映しています。環境が素朴なのは象徴的なソファの誘目性を高める工夫であり、天気はやや曇りで奇妙さを演出しています。爽やかな草原と書きましたが、見ようによっては果てしなく無限に広がっていそうという意味では奇妙かもしれません。ソファは、歩くのが面倒くさいギリギリの距離に置いたので、ダッシュもできるようにしました。
                  <br />
                  ソファのモデリングは初めてでした。奇妙な空間なので、形状や布の質感など愛着が持てるか持てないか、どっちとも捉えられそうなラインを攻めました。
                  <br />
                  実装の多くは、コーディングエージェントとの往復で進めています。事前学習として、基礎的事項をThree.js Journeyで押さえた上で、具体的に形にしていく作業はAIをフル活用してスピード違反で進めました。
                  <br />
