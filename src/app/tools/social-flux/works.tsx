        ...
        <Glass>
          ...
          <main className={clsx(main)}>
            <WorksInfo
              ...
              imageWidth={6000}
              imageHeight={4500}
              what="公開統計をもとに地域社会の移ろいを「流れ」として可視化するデータビジュアライゼーションツール。制作では、統計データが示す固定的なグラフと時間の流れを内包したビジュアル表現を目指し、D3.jsの折れ線グラフが社会の輪郭を示し、Three.jsのシェーダー背景がその背後にある気配や温度を描きます。"
