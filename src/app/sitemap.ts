...
const routes: {
  ...
  { path: "/tools/mujo-words", changeFrequency: "yearly", priority: 0.7 },
  { path: "/tools/social-flux", changeFrequency: "yearly", priority: 0.7 },
  ...
  { path: "/playgrounds/the-rest", changeFrequency: "yearly", priority: 0.5 },
